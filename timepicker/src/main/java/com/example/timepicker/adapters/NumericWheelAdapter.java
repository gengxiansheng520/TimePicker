...
package com.example.timepicker.adapters;
...
public class NumericWheelAdapter extends AbstractWheelTextAdapter {
    ...
    public NumericWheelAdapter(Context context, int minValue, int maxValue, String format, String unit) {
        this(context, minValue, maxValue, format, unit, 1);
    }
     ...
     * @param unit     the wheel unit value
     */
    public NumericWheelAdapter(Context context, int minValue, int maxValue, String format, String unit, int interval) {
        super(context);
