...
package com.example.timepicker.wheel;
...
import com.example.timepicker.adapters.WheelViewAdapter;
...
public class WheelView extends View {
    ...
    private void initData(Context context, AttributeSet attrs) {
        ...
        try {
            //背景图片
            visibleItems = typedArray.getInt(R.styleable.WheelView_itemCount, DEF_VISIBLE_ITEMS);
            Log.d("huangcan", "initData: " + visibleItems);
        } finally {
            typedArray.recycle();
        }
